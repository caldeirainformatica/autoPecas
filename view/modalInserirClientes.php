          ...
          <div class="modal-body ">
              <form  action="../control/ConCliente.php?acao=novo" method="post">
                  ...
                  <fieldset>
                      ...
                      <label class="radio-inline "><input type="radio" name="tipopessoa" id="radiofisica" value="fisica" required="required">Física</label>
                      <label class="radio-inline "><input type="radio" name="tipopessoa" id="radiojuridica" value="juridica" required="required">Jurídica</label>
...
<!--                  <div class="form-group">-->
                <div class="col-md-6 col-lg-6">
                  <fieldset>
                      ...
                      <label for="tel">Celular:</label><input name="celular" id="tel" class=" form-control"><br>
                      <label for="tel">Telefone Fixo</label><input name="fixo" id="tel" class=" form-control"><br>
